...
$query="SELECT * FROM $tabel WHERE judul = '$judul'";
//echo $query;
...
<form action="admin.php?p=artikelsimpanedit" method="post">
	<div class="element">
		<label for="name">Judul Artikel <span class="red">(required)</span></label>
		<input id="judul" name="judul" class="text err" value="<?php echo $judul; ?>" />
	</div>
	<div class="element">
